    ...
    <div class="main-content-inner">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <c:if test="${not empty buildingEditDTO.id}">
                                            ...
                                            <button type="button" class="btn btn-danger" id="btnCancel"> Huỷ thao tác
                                            </button>
                                        </c:if>
        ...
        <script>
            $("#btnAddOrUpdateBuilding").click(function () {
                ...
                // Lấy tất cả input từ form
                var fromData = $("#listForm").serializeArray();
                $.each(fromData, function (i, field) {
                    if (field.name === "typeCode") {
                        // Nếu typeCode có nhiều giá trị
                        formData.append("typeCode", field.value);
                    } else {
                ...
                $.ajax({
                    ...
                    url: "${buildingAPI}",
                    data: formData,
                    processData: false,  // Không convert formData thành string
                    contentType: false,  // Đặt multipart/form-data tự động
                    success: function (respond) {
                        console.log("Thêm/Cập nhật toà nhà thành công");
                    },
                    error: function (respond) {
                        console.log("Thêm/Cập nhật toà nhà thất bại");
                        console.log(respond);
                    }
                });
            });
